...
Long Method | [Lecture 16](#section-2-lecture-16)
...
Generally, you want methods that _specialize_ in **one** thing
...
public partial class Download : System.Web.UI.Page
{
    private readonly DataTableToCsvMapper _dateTableToCsvMapper = new DataTableToCsvMapper();
